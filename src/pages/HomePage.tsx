    ...
    return (
        <div className="bg-[#0a1628] h-screen flex flex-col p-4 mx-6 text-white">
            ...
            <div className='flex flex-row gap-2 mt-4'>
                <button className='rounded-2xl m-2 px-2 py-1 bg-teal-800/70 text-teal-500 hover:bg-teal-700/50' onClick={() => handleFilter('beginner')}>Beginner</button>
                <button className='rounded-2xl m-2 px-2 py-1 bg-teal-800/70 text-teal-500 hover:bg-teal-700/50' onClick={() => handleFilter('intermediate')}>Intermediate</button>
                <button className='rounded-2xl m-2 px-2 py-1 bg-teal-800/70 text-teal-500 hover:bg-teal-700/50' onClick={() => handleFilter('advanced')}>Advanced</button>
            </div>
            <Feed videos={videos} />
